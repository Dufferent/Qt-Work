...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Server_Widget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 62, 7)
    ...
    "netconfig\0exit\0offline\0process\0"
};
...
const QMetaObject Server_Widget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Server_Widget.data,
      qt_meta_data_Server_Widget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Server_Widget.stringdata))
